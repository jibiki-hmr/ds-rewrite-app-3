...
const inMemorySessionStorage = sessionStorageMemory.default?.inMemorySessionStorage || sessionStorageMemory.inMemorySessionStorage;
...
const shopify = shopifyApp({
  ...
  authPathPrefix: "/auth",
  sessionStorage: inMemorySessionStorage(), // ✅ これで解決！
